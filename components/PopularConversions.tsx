    ...
    >
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div>
          ...
          <div className="text-[11px] text-slate-400 mt-0.5 font-medium truncate">{fromCur?.name}</div>
        </div>
      </div>
      ...
      <div className="text-right shrink-0 ml-2">
        {isLoading ? (
          ...
          <>
            ...
            <div className="text-[11px] text-slate-400 mt-0.5">{toCur?.code}</div>
          </>
        ) : (
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-7">
      <div className="mb-5">
        ...
        <p className="text-xs text-slate-400 mt-0.5">Tap any to switch instantly</p>
      </div>
